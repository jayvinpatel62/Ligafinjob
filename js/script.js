...
$(".nav-home-tab .tab-item").on("click", function () {
  // makes sure the whole site is loaded
  $(".sectLoader-wrapper").delay(350).fadeIn("slow"); // will fade out the white DIV that covers the website.
  setTimeout(() => {
    $(".sectLoader-wrapper").fadeOut("slow");
  }, 2000);
});
...
$(".passShowHide").click(function () {
  ...
  "password" == type1
    ? (document.getElementById("ctl00_ucLoginPopUp_txtPassword").type = "text")
    : (document.getElementById("ctl00_ucLoginPopUp_txtPassword").type =
        "password");
});
...
$(".passShowHide1").click(function () {
  ...
  "password" == type1
    ? (document.getElementById("ctl00_ucLoginPopUp_txtRegPassword").type =
        "text")
    : (document.getElementById("ctl00_ucLoginPopUp_txtRegPassword").type =
        "password");
});
...
$(".passShowHide2").click(function () {
  ...
  /* alert(document.getElementById("ctl00_ucLoginPopUp_txtPassword").type);*/
  let type1 = document.getElementById(
    "ctl00_ContentPlaceHolder1_txtsal"
  ).type; /*ctl00$ucLoginPopUp$txtPassword*/
  //alert(type1);
  if ("password" == type1) {
    //alert("1");
    ...
    //alert("2");
    document.getElementById("ctl00_ContentPlaceHolder1_txtsal").type =
      "password";
